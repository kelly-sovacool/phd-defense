...
- Diagnose CRC early and less invasively than colonoscopy.
...
- Multiple copies of target genes for amplicon sequencing in many bacteria.
:::
...
Solution: cluster amplicon sequences into operational taxonomic units (OTU).
...
:::{.notes}
TODO just show closed reference vs de novo
:::
...
- New method: use _de novo_ OTUs as a reference for new sequences.
...
## OptiFit is suitable for machine learning
...
:::{.notes}
TODO diagram how otus clustered to create relabun table.
transition to next slide by discussing data format
:::
...
:::{.big-middle}
Would deploying EHR and/or OTU-based models improve clinical outcomes?
:::

:::{.notes}
TODO image / plot / table instead of text / reduce text to main points
...
:::{.notes}
TODO image or diagram here?

transition: 3 key audiences. high schoolers, academic researchers, novice ML practitioners
:::

## Addressing the gender gap in STEM

- 18% of CS degrees are awarded to women.
- U-M Bioinformatics PhD graduates: 25% women. The disparity begins at the application stage.
- Most of us (women in U-M Bioinformatics) didn't learn to code until college or later.

:::{.fragment}
**Solution:** start a Girls Who Code club focused on teaching coding for data science to high schoolers.
...
:::{.notes}
TODO revise text for succinctness
...
:::{.notes}
three key audiences: high schoolers, researchers, and novice ML practitioners.
:::
...
:::{.notes}
schlabbies are wonderful people
:::
