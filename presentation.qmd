...
## Intro to Python for Data Science {background-image="img/logo/gwc.png" background-size="300px" background-position="top 20px right 20px"}
...
## Impact of Girls Who Code {background-image="img/logo/gwc.png" background-size="300px" background-position="top 20px right 20px"}
...
## Integrated curriculum teaching R, Unix shell, & Git for reproducible research {background-image="img/logo/software-carpentry.png" background-size="200px" background-position="top 30px right 20px"}
