...
- Clusters sequnces at the same quality as _de novo_ methods.
- Outperforms other reference-based methods in terms of quality and fraction mapped.
...
TODO does plot have extra whitespace around top/bottom margins?
...
![](img/logo/gwc.png){width=500px fig-align="center"}
:::
...
- U-M instance of Software Carpentry active since 2016. TODO revise text for succinctness
...
### teaching R, the Unix shell, & Git for reproducible research
...
![](img/mikropml-pipeline.png){fig-align="center"}
...
## mikropml follows best practices in software engineering {background-image="img/hex/logo_mikropml.png" background-size="150px" background-position="top 20px right 20px"}
...
:::{.column width="50%"}
![](img/frontispiece.png){height=350px fig-align="left"}
:::

:::{.column width="40%" .smaller-text .align-center .fragment}
<br>

##### post-PhD plans
Bioinformatics Software Engineer for Frederick National Lab (NIH/NCI)

![](img/logo/fnlcr.png){fig-align="center"}
:::
...
## TODO friends {background-image="img/acknowledgements.png" background-size="contain"}



## TODO family and David {}

## Congratulations! &nbsp; 🎉 {visibility="uncounted"}
