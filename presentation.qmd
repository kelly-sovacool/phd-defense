...
## Supplemental slides {visibility="hidden"}

## 5-fold cross validation {visibility="hidden"}
...
## Decision trees {visibility="hidden"}

![](img/decision-trees.png)

## Random forest {visibility="hidden"}

![](img/random-forest.png)

## A more fair comparison? {.smaller visibility="hidden"}
...
## Limitation: class imbalance {visibility="hidden"}
...
## Solution: calculate the balanced precision {visibility="hidden"}
...
## Balanced Precision {.smaller visibility="hidden"}
